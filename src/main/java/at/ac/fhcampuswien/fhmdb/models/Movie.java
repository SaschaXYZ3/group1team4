    ...
    public static List<Movie> initializeMovies() {
        List<Movie> movies = Arrays.asList(
                ...
                new Movie("Life Is Beautiful", "When an open-minded Jewish librarian and his son become victims of" +
                        "the Holocaust he uses a perfect mixture of will, humor, and imagination to protect his son" + "from the dangers around their camp.",
                ...
                new Movie("Puss in Boots", "An outlaw cat his childhood egg-friend, and a seductive thief kitty set out in " +
                        "seych for the eggs of the fabled Colden Goose to clear his name, restore his lost" + "honore and regain the trust of his mother and town.",
                        Arrays.asList(Genre.COMEDY, Genre.FAMILY, Genre.ANIMATION)),
                new Movie("Avatar", "A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn " +
                        "beüeen following his orders and protecting the world he feels is his" + "home.",
                        Arrays.asList(Genre.ANIMATION, Genre.DRAMA, Genre.ACTION)),
                new Movie("The Wolf of Wall Street", "Based on the frue Story of Jordan Belfort from his rise ö wealthy " +
                        "stock-broker living the high life to his fall involving crime, corruption and the federal" + "govemrnent.",
